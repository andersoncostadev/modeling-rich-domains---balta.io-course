...
{
    public class CreateBoletoSubscriptionCommand : Notifiable<Notification>, ICommands
    {
        ...
        public void Validate()
        {
            AddNotifications(new Contract<Notifiable<Notification>>()
               ...
               .IsLowerThan(LastName, 40, "Name.LastName", "Nome deve conter até 40 caracteres")
           );
        }
    }
}
